...
<div class="w3-top">
  ...
  <div class="w3-bar" id="myNavbar">
    ...
    <a href="./#video" class="w3-bar-item w3-button w3-hide-small" style="color: #e3405d;"><i class="fa fa-play"></i> VIDEO SAMPLES</a>
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium">
    ...
    <a href="portfolio.php" class="w3-bar-item w3-button" onclick="toggleFunction()">PHOTO</a>
...
<div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
  <div class="w3-display-middle" style="white-space:nowrap; top: 17%;">
    <span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity"><span> PHOTOGRAPHY</span>
  </div>
</div>
